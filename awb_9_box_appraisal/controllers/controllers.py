...
class Appraisal(http.Controller):
    ...
    # @http.route('/appraisal/appraisal/objects/', auth='public')
    # def list(self, **kw):
    #     return http.request.render('appraisal.listing', {
    #         'root': '/appraisal/appraisal',
    #         'objects': http.request.env['appraisal.appraisal'].search([]),
    #     })
    #
    # @http.route('/appraisal/appraisal/objects/<model("appraisal.appraisal"):obj>/', auth='public')
    # def object(self, obj, **kw):
    #     return http.request.render('appraisal.object', {
    #         'object': obj
    #     })
